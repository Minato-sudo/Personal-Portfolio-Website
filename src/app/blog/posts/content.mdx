...
`const home = {
    label: "Home",
    title: "Talha Arshad's Portfolio",
    description: "Portfolio website showcasing my work as a Data Scientist & AI/ML Engineer",
    headline: <>Turning data into decisions, and ideas into intelligence.</>,
    subline: (
      <>
        I'm Talha, a Data Scientist and AI/ML Engineer at <InlineCode>FAST-NUCES</InlineCode>,
        <br /> where I build predictive models, NLP systems, and data pipelines.
      </>
    ),
};`,
    language: "tsx",
